...
//
//
//vector<pair<int, int>> GameRules::possibleMoves(Board board, string color) {
...
//};
//
//vector<pair<int, int>> GameRules::removeOutOfBounderyMoves(vector<pair<int, int>> possible_moves, int board_size) {
...
//
//
//bool GameRules::isGameOver(Board board) {
//    board.printBoard();
...
//
//
//void GameRules::resetBoard(Board* board) {
//
